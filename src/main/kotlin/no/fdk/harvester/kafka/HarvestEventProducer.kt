    ...
    fun produceHarvestingEvent(
        ...
        return try {
            ...
            logger.debug(
                ...
                topicName,
                key,
                harvestingEvent.phase,
                harvestingEvent.runId,
                harvestingEvent.dataType,
                harvestingEvent.dataSourceId,
                harvestingEvent.dataSourceUrl,
                harvestingEvent.startTime,
                harvestingEvent.endTime,
                harvestingEvent.errorMessage,
                harvestingEvent.changedResourcesCount,
                harvestingEvent.removedResourcesCount,
            )
            future
        } catch (ex: Exception) {
    ...
    fun produceHarvestingEvent(
        ...
        try {
            ...
            logger.debug(
                ...
                event.endTime,
                event.errorMessage,
                event.changedResourcesCount,
                event.removedResourcesCount,
            )
        } catch (e: Exception) {
