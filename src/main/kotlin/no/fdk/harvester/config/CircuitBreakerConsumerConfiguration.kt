...
open class CircuitBreakerConsumerConfiguration(
    ...
    private fun attachListener(registry: CircuitBreakerRegistry) {
        registry
            .circuitBreaker(CIRCUIT_BREAKER_ID)
            .eventPublisher
    ...
    @Bean
    open fun harvesterCircuitBreaker(registry: CircuitBreakerRegistry): CircuitBreaker = registry.circuitBreaker(CIRCUIT_BREAKER_ID)
