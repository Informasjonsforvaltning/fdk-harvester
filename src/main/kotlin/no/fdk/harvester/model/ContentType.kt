...
enum class ContentType(
    ...
    fun isRDF(): Boolean = listOf(TURTLE, N3, TRIG, RDFXML, RDFJSON, JSONLD, NTRIPLES, NQUADS, TRIX).contains(this)

    companion object {
        fun fromValue(contentType: String?): ContentType? = values().find { it.headers.contains(contentType?.lowercase()) }
    }
}
